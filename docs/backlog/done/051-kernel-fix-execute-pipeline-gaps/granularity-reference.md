...
## Status
NEW — the most important deliverable in this backlog

## Location
`.claude/skills/task-builder/references/granularity-reference.md`

Referenced by: `step-05-decompose.md` and `step-06-atomize.md` via wikilink.
