# Claude Code Harness Marketplaces & Distribution Platforms

## Overview

This document catalogs all major platforms and marketplaces where Claude Code harnesses, plugins, skills, and agent automation tools are distributed and discovered.
