...
2. **Test repo is disposable.** Every eval creates a fresh test repo at `D:\my_ai_projects\project_test_repos\eval-[target]-test\`. It can be deleted after scoring. Never test in-place.
